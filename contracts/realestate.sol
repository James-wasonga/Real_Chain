...
contract RealEstate {
    ...
    function addProperty(string memory _location, uint256 _price, string memory _image) public {
        propertyCounter++;
        properties[propertyCounter] = Property(_location, _price, msg.sender, true, _image);
